...
The Guide is knowledge, not calculation: 348 procedures, no database, no server
...
The **Guide** tab needs no data at all — the 348 procedures are built in. Pick
...
**348 procedures across 25 displays.** Every answer carries the file format, the
...
model download. This is possible only because the text is a closed set: 348
...
This is that idea taken seriously: 348 procedures, a real software-version
